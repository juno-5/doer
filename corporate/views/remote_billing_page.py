...
def remote_realm_billing_finalize_login(
    ...
    *,
    ...
    return remote_realm_billing_finalize_login_core(
        request,
...
def remote_realm_billing_finalize_login_core(
    request: HttpRequest,
    *,
    identity_dict: RemoteBillingIdentityDict,
    full_name: str | None = None,
    tos_consent_given: bool = False,
    enable_major_release_emails: bool = False,
    enable_maintenance_release_emails: bool = False,
) -> HttpResponse:
    ...
    if request.method == "GET":
        signed_billing_access_token = signing.dumps(identity_dict)
    ...
    if full_name is not None:
        ...
        remote_user.enable_major_release_emails = enable_major_release_emails
        remote_user.enable_maintenance_release_emails = enable_maintenance_release_emails
...
def remote_realm_billing_from_login_confirmation_link(
    ...
    *,
    ...
    return remote_realm_billing_finalize_login_core(request, identity_dict=identity_dict)
