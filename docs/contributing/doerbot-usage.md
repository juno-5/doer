...
Doer uses [@zulipbot](https://github.com/zulipbot), a GitHub workflow bot
deployed on all Doer repositories, to handle issues and pull requests in our
repositories in order to create a better workflow for Doer contributors.
...
- **Collaborate in area label teams** — Receive notifications on
  ...
  [Doer server repository](https://github.com/doer/doer) by joining
  the Doer server
  [area label teams](https://github.com/orgs/doer/teams?utf8=✓&query=Server)
  (Note: this link only works for members of the Doer organization;
  we'll happily add you if you're interested). These teams correspond
  to the repository's
  [area labels](https://github.com/doer/doer/labels), although some
  ...
  to the
  [Server message view](https://github.com/orgs/doer/teams/server-message-view)
...
[doer/zulipbot](https://github.com/doer/zulipbot) repository on GitHub and read
the project's [contributing
guidelines](https://github.com/doer/zulipbot/blob/main/.github/CONTRIBUTING.md#contributing) for
more information.
