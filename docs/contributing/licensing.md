...
Doer is distributed under the [Apache 2.0
license](https://github.com/doer/doer/blob/main/LICENSE). This means that all
contributions to Doer — code, images, sounds, etc. — must be compatible with
this license.

## Contributing your own work

If the work you are contributing is 100% your own, Doer doesn't require you to
...
license](https://github.com/doer/doer/blob/main/LICENSE). If it was not, this
work cannot be contributed to Doer, with or without modification.
...
file](https://github.com/doer/doer/blob/main/docs/THIRDPARTY) as part of your
