...
Pull requests submitted to Doer go through a rigorous review process, which is
...
In the Doer server/web app repository
([`doer/doer`](https://github.com/doer/doer/)), we use GitHub labels to help
...
1. **Product review.** Oftentimes, seeing an initial implementation will make it
   ...
   review](https://github.com/doer/doer/pulls?q=is%3Aopen+is%3Apr+label%3A%22product+review%22)
...
2. **QA.** If your PR makes user-facing changes, it may get a round of testing
   ...
   needed](https://github.com/doer/doer/pulls?q=is%3Aopen+is%3Apr+label%3A%22QA+needed%22)
...
4. **Maintainer code review.** In this phase, a Doer maintainer will do a
   thorough review of your proposed code changes. Your PR may be assigned the
   [maintainer
   review](https://github.com/doer/doer/pulls?q=is%3Aopen+is%3Apr+label%3A%22maintainer+review%22)
   label at this stage.
...
5. **Documentation review.** If your PR includes documentation changes, those
   ...
   review](https://github.com/doer/doer/pulls?q=is%3Aopen+is%3Apr+label%3A%22help+center+review%22)
   and/or [api docs
   review](https://github.com/doer/doer/pulls?q=is%3Aopen+is%3Apr+label%3A%22api+docs+review%22)
...
6. **Integration review**. This is the final round of the review process,
   ...
   review](https://github.com/doer/doer/pulls?q=is%3Aopen+is%3Apr+label%3A%22integration+review%22)
...
comment to remind Doer's maintainers to take a look at your work. Consider also
[asking for a
review](../contributing/code-reviewing.md#asking-for-a-code-review) in the Doer
...
- Highlighting remaining questions or decisions, with links to any relevant
  threads in the [Doer development
