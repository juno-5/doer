...
If you have ideas for how to make Doer better, we'd love to hear from you! Many
improvements start with a user's suggestion. The best way to suggest a feature
or an improvement is by starting a conversation in the [Doer development
...
Doer for you and other users.

Usually, if the discussion leads to a concrete proposal, Doer's product team
...
- Provide context on how the change you are proposing would help you or your
  organization. It is often helpful to describe how you are using Doer (e.g.,
  "I work at a small startup", or "I'm teaching a class"). This lets us combine
  our Doer expertise with your requirements to come up with a great design for
  a feature.
...
2. Pick an **appropriate channel** to discuss your idea:
   - [#feedback](https://chat.zulip.org/#narrow/channel/137-feedback) for suggestions for
     the Doer web app or server. Use this channel if you aren't sure which channel is
     most appropriate.
   ...
   - [#desktop](https://chat.zulip.org/#narrow/channel/16-desktop) for suggestions
     that are specific to the Doer desktop app.
...
1. File the issue in the **appropriate [Doer
   repository](https://github.com/doer)**. The most commonly used repositories
   are:
   - [doer/doer](https://github.com/doer/doer/issues) for suggestions for the
   ...
   - [doer/doer-desktop](https://github.com/doer/doer-desktop/issues) for
     suggestions that are specific to the Doer desktop app.
...
If you have been involved in the decision to use (or not use!) Doer, or are
...
- **Pros and cons**: What are the pros and cons of Doer for your organization,
  and the pros and cons of other products you are evaluating?
- **Features**: What are the features that are most important for your
  organization? In the best-case scenario, what would your chat solution do
  for you?
- **Onboarding**: If you remember, what were your impressions during your first
  few minutes of using Doer? What did you notice, and how did you feel? Was
