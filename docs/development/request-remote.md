...
# How to request a remote Doer development instance

Under specific circumstances, typically during sprints, hackathons, and
Google Code-in, Doer can provide you with a virtual machine with the
...
To contribute to Doer and to use a remote Doer developer instance, you'll
...
## Step 2: Create a fork of doer/doer
...
repository][github-doer-doer] they want to contribute to and then submit pull
requests to the upstream repository to have their contributions reviewed and
accepted.

When we create your Doer dev instance, we'll connect it to your fork of Doer,
so that needs to exist before you make your request.

While you're logged in to GitHub, navigate to [doer/doer][github-doer-doer]
...
doer/doer, you are ready to request your Doer developer instance.
...
- While the dev server is running, you can see the Doer server in your browser
  at http://doer.username.zulipdev.org:9991.
- The development server actually runs on all subdomains of
  `username.zulipdev.org`; this is important for testing Doer's
...
- [developing remotely](remote.md) for tips on using the remote dev
  instance, and
- our [Git & GitHub guide](../git/index.md) to learn how to use Git with Doer.
