...
When you work on Doer code, there are three copies of the Doer Git
repository that you are generally concerned with:

- The `upstream` remote. This is the [official Doer
  repository](https://github.com/doer/doer) on GitHub. You probably
...
When you work on Doer code, you will end up moving code between
...
- You may fork the official Doer repository to your GitHub fork.
- You may fetch commits from the official Doer repository to your local copy.
...
- You submit a PR to the official Doer repo.

Finally, the Doer core team will occasionally want your changes!

- The Doer core team can accept your changes and add them to
