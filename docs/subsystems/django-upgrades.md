...
This article documents notes on the process for upgrading Doer to
...
- Carefully read the Django upstream changelog, and `git grep` to
  ...
  [example](https://github.com/doer/doer/issues/2564).
...
- Look at the pieces of Django code that we've copied and then
  ...
  - `CursorDebugWrapper`, which we have a modified version of in
    ...
    [the issue for contributing this upstream](https://github.com/doer/doer/issues/974)
