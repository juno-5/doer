...
import ExternalLinkIcon from "~icons/doer-icon/external-link";
...
into a link to `https://github.com/doer/doer/issues/2468`.

If the pattern appears in a topic, Doer adds an
**Open** (<ExternalLinkIcon />) button
to the right of the topic in the message recipient bar that links to
the appropriate URL.

If you have any trouble creating the linkifiers you want, please [contact Doer
...
* Pattern: `#(?P<id>[0-9]+)`
* URL template: `https://github.com/doer/doer/issues/{id}`
* Original text: `#2468`
* Automatically links to: `https://github.com/doer/doer/issues/2468`
...
variants. For example, the Doer development community
[uses](https://zulip.com/development-community/#linking-to-github-issues-and-pull-requests)
`#M2468` for an issue in the repository for the Doer mobile app,
`#D2468` and issue in the desktop app repository, etc.

* Pattern: `#F(?P<id>[0-9]+)`
* URL template: `https://github.com/doer/doer-flutter/issues/{id}`
* Original text: `#F245`
* Automatically links to: `https://github.com/doer/doer-flutter/issues/245`
...
* URL template: `https://github.com/doer/doer/commit/{id}`
* Original text: `abdc123`
* Automatically links to: `https://github.com/doer/doer/commit/abcd123`
...
This example pattern is a shorthand for linking to pages on Doer's ReadTheDocs
site.
...
repository references like `doer-desktop#123` link to issues in that
repository within the `doer` GitHub organization. A more specific
...
* General linkifier
  ...
  * URL template: `https://github.com/doer/{repo}/pull/{id}`
...
* Example matching only the general linkifier:
  * Original text: `doer-desktop#123`
  * Automatically links to: `https://github.com/doer/doer-desktop/pull/123`
