...
import GifIcon from "~icons/doer-icon/gif";
...
Doer integrates with [GIPHY](https://giphy.com) and [Tenor](https://tenor.com/), allowing you to
...
Doer’s GIF picker supports third-party services, currently GIPHY
...
Doer proxies all external images in messages through the server,
