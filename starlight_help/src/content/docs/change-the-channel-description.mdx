...
Channel descriptions support Doer's standard [Markdown
formatting][markdown-formatting], with the exception that image previews are
disabled. Use Markdown formatting to include a link to a website, Doer
...
<Tabs>
  ...
  <TabItem label="Mobile">
    ...
    GitHub](https://github.com/doer/doer-flutter/issues/1102). If
