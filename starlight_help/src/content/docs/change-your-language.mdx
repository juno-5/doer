...
## Change the language of the Doer app
...
<Tabs>
  ...
  <TabItem label="Mobile">
    ...
    GitHub](https://github.com/doer/doer-flutter/issues/1139). If
...
Doer uses the Source Sans 3 font, which [supports over 30 languages][adobe-docs].
