...
Doer uses the time zone configured on your computer or mobile device for
...
computer's time zone, the Doer web and desktop apps display a banner offering
...
## Configure time zone used by Doer to display dates and times
...
If you local time in Doer differs from your device's time zone (for example,
