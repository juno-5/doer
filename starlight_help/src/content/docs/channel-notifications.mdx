...
import ResetIcon from "~icons/doer-icon/reset";
...
<Tabs>
  ...
  <TabItem label="Mobile">
    ...
    GitHub](https://github.com/doer/doer-flutter/issues/1223). If
...
<Tabs>
  ...
  <TabItem label="Mobile">
    ...
    Implementation of this feature in the mobile app is tracked [on
    GitHub](https://github.com/doer/doer-flutter/issues/661). If
    you're interested in this feature, please react to the issue's
    description with 👍.
  </TabItem>
</Tabs>
