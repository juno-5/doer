...
organization's guidelines for using Doer.
...
<FlattenedSteps>
  ...
  1. Under **Onboarding**, enable **Send a custom Welcome Bot message to
     new users**.
  1. Under **Message text**, enter a custom welcome message using Doer's standard
...
<FlattenedSteps>
  ...
  1. Under **Message text**, enter the welcome message to use for this
     invitation using Doer's standard [Markdown
