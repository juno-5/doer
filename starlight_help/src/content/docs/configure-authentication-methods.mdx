...
The following options are available for organizations on Doer Cloud Standard,
Doer Cloud Plus, and all self-hosted Doer servers:

* Oauth2 with Microsoft Entra ID (AzureAD)

The following options are available for organizations on Doer Cloud Plus, and all self-hosted Doer servers:
...
Doer Cloud organization, contact [support@zulip.com](mailto:support@zulip.com)
to inquire.
...
<FlattenedSteps>
  ...
  1. To use SAML authentication or SCIM provisioning, Doer Cloud organizations
     must upgrade to [Doer Cloud Plus](https://zulip.com/plans/), and contact
