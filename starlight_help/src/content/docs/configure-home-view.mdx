...
The home view in Doer is the view you reach after logging in
to the Doer web app. You can also navigate to the home view via
keyboard shortcuts.

The home views available in Doer are
[**Inbox**](/help/inbox),
...
<FlattenedSteps>
  ...
  1. Under **Navigation**, click on the **Home view** dropdown
     and select a view.
  1. To see your changes in action, open a new Doer tab, or use a keyboard
...
Doer has a number of [keyboard shortcuts](/help/keyboard-shortcuts)
...
This will not disable other <kbd>Esc</kbd> key shortcuts used in Doer,
