...
Each user can use Doer with [their preferred language][user-lang].
...
* Is used as the default language for new user accounts when Doer
  cannot detect their language preferences from their browser,
  including all users [created via the Doer API][api-create-user].
