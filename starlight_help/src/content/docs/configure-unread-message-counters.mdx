...
To provide information about unread messages, Doer can show unread message
...
Doer offers an option to display a dot instead of an unread counter for channels
...
You can configure whether Doer displays unread count summaries on your home
