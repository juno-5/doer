...
Some corporate and university networks may require you to connect to Doer
via a proxy.

## Web

Doer uses your browser's default proxy settings. To set a custom proxy just
for Doer, check your browser's instructions for setting a custom proxy for
a single website.
...
<Tabs>
  <TabItem label="System proxy settings">
    <FlattenedSteps>
      ...
      1. Restart the Doer desktop app.
    </FlattenedSteps>
  </TabItem>
