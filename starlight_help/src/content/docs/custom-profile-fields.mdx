...
Doer supports many types of profile fields, such as dates, lists of options,
account links, and [more](#profile-field-types). You can choose which
...
Doer supports synchronizing custom profile fields from an external
...
All field types other than "Paragraph" or "Person" have a checkbox option
...
banner every time they open the Doer web or desktop app prompting them to fill
it out.
