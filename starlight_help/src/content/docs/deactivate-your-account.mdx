...
In Doer, you have a dedicated account for each organization you belong to.
Deactivating your Doer account in one organization will have no effect on any
other Doer accounts you may have.
...
<DoerTip>
  You can find all the Doer Cloud accounts associated with your email address
