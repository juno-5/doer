...
Doer lets you delete the content of your messages or delete messages completely
...
Doer's [edit history](/help/view-a-messages-edit-history) feature.  This can be
...
messages will immediately disappear from the UI in all official Doer clients.
...
time, they are permanently and irrecoverably deleted from the Doer
