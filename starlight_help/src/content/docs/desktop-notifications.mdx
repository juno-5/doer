...
Doer can be configured to send visual and audible desktop notifications for
...
You can select the sound Doer uses for audible desktop notifications. Choosing
...
By default, Doer displays a count of your unmuted unread messages on the
...
Desktop notifications are triggered when a message arrives, and Doer is not
in focus or the message is offscreen. You must have Doer open in a browser
tab or in the Doer desktop app to receive desktop notifications.
...
notifications for new messages, check your Doer notification settings. Make
...
notifications from Doer. Before checking Doer-specific settings, make sure
that **Do Not Disturb mode** is not enabled on your computer.

<Tabs>
  <TabItem label="Chrome">
    <Steps>
      1. Click on the site information menu to the left of the URL for your Doer
         organization.
    ...
    <Steps>
      ...
      1. Paste the Doer URL for your organization into the site field, and
         click **Add**.
    </Steps>
  </TabItem>
  ...
  <TabItem label="Firefox">
    <Steps>
      ...
      1. Find the URL for your Doer organization, and adjust the **Status**
         selector to **Allow**.
    </Steps>
  </TabItem>
  ...
  <TabItem label="Desktop app">
    **Windows**
    ...
    <Steps>
      ...
      1. Select **Doer** from the list of apps.
      1. Configure the notification style that you would like Doer to use.
    </Steps>
