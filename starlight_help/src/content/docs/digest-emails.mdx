...
Doer has a beta feature to send weekly emails to users who haven't
...
plain-text formats by visiting `https://doer.example.com/digest/`,
if `https://doer.example.com` is your Doer server URL.
