...
Doer sends a handful of emails to new users, introducing them to the Doer
...
email notifying them about their new Doer account and how to log in.
...
<FlattenedSteps>
  ...
  1. Under **Onboarding**, toggle
     **Send emails introducing Doer to new users**.
</FlattenedSteps>
