...
The Doer desktop app offers a **Do Not Disturb (DND)** mode. Turning on **Do Not
Disturb** mode disables [desktop notifications](/help/desktop-notifications)
across all the organizations you have
[added](/help/logging-in#log-in-to-a-new-organization) to the Doer desktop app.
...
<DoerNote>
  ...
  notifications](/help/desktop-notifications) in the Doer web app.
</DoerNote>
  ...
  <TabItem label="Desktop">
    <Steps>
      1. Click the **bell** (<BellIcon />) or **bell with a slash** (<BellSlashIcon />) icon in the **organizations sidebar** on the
         left. You can also select **Toggle Do Not Disturb** from the **Doer** menu in
         the top menu bar.
    </Steps>
