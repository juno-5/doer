...
This page answers some frequently asked questions about [Doer Cloud plans and
...
## Upgrade to a Doer Cloud Standard or Plus plan
...
<Tabs>
  <TabItem label="Pay by credit card">
    <FlattenedSteps>
      ...
      1. On the page listing Doer Cloud plans, click the button at the bottom
...
If you cancel your plan, your organization will be downgraded to **Doer Cloud
...
## Free and discounted Doer Cloud Standard

Doer sponsors free plans for over 1000 worthy organizations. The following
types of organizations are generally eligible for a free **Doer Cloud Standard** plan.
...
* Most communities that need features beyond the Free plan in order to use Doer.

The following types of organizations are generally eligible for significant
discounts on **Doer Cloud Standard**.
...
Educators using Doer with students are eligible for discounted [education
...
<DoerTip>
  ...
  teaching one or more classes) usually find that the [Doer Cloud Free
...
Submit a sponsorship request to apply for a free or discounted **Doer Cloud
Standard** plan. If you do not have a Doer organization yet, contact
...
<Tabs>
  <TabItem label="Request sponsorship">
    ...
    <DoerTip>
      ...
      above](#free-and-discounted-doer-cloud-standard) that best fits
      your organization.
    </DoerTip>
  </TabItem>
...
## Differences between Doer Cloud plans

### How does having 10,000 messages of search history on Doer Cloud Free work?

Only the most recent 10,000 messages can be viewed and searched on the Doer
Cloud Free plan. Older messages are still stored and will become available
again if the organization is upgraded to **Doer Cloud Standard**.

### Will you switch to limiting Doer Cloud Free history to messages sent in the last 90 days (like Slack has)?
