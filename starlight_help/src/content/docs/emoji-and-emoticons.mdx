...
import SmileBiggerIcon from "~icons/doer-icon/smile-bigger";
...
<Tabs>
  ...
  <TabItem label="Via paste">
    <FlattenedSteps>
      ...
      1. Paste an emoji copied from outside of Doer directly into the compose box.
    </FlattenedSteps>
  </TabItem>
</Tabs>
...
You can configure Doer to convert emoticons into emoji, so that, e.g., `:)`
...
<Tabs>
  ...
  <TabItem label="Via paste">
    <Steps>
      1. [Start a new topic](/help/introduction-to-topics#how-to-start-a-new-topic).
      1. Paste an emoji copied from outside of Doer directly into the text input box.
    </Steps>
...
you send. Doer emoji are compatible with screen readers and other accessibility tools.
