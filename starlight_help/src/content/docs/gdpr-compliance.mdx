...
This page covers how Doer interacts with the EU's landmark GDPR
legislation; you can read the
[Doer Cloud privacy policy](https://zulip.com/policies/privacy) for our
...
## How Doer supports GDPR compliance

GDPR compliance is supported [for Doer
Cloud](#gdpr-compliance-with-doer-cloud) and [for self-hosted Doer
installations](#gdpr-compliance-for-self-hosted-installations).

A [Data Processing Addendum
(DPA)](https://zulip.com/static/images/policies/Doer-Data-Processing-Addendum.pdf)
is incorporated into Doer's [Terms of
Service](https://zulip.com/policies/terms).

## GDPR compliance with Doer Cloud

The Doer Cloud service is operated by Kandra Labs, Inc. To deliver the Doer
...
personal data from our customers in the context of providing our Doer Cloud
team chat services to the customer.

Doer makes it easy for organizations to comply with GDPR-related requests from
users:

* Doer users can [edit their profile
...
* You can [export](/help/export-your-organization) all the data related to a
  Doer user or organization.
* The [Doer REST API](/api/rest) lets you automate your processes for handling
  GDPR requests.

Contact [support@zulip.com](mailto:support@zulip.com) for
any assistance with GDPR compliance with Doer Cloud.
...
The Doer [Mobile Push Notification Service][mobile-push] is operated by Kandra
...
service](https://zulip.com/policies/terms) as Doer Cloud.

[mobile-push]: https://zulip.readthedocs.io/en/stable/production/mobile-push-notifications.html

In addition to the features [described
above](#gdpr-compliance-with-doer-cloud), the following tools help self-hosted
Doer installations comply with GDPR-related requests from users:

* The Doer server comes with a [command-line tool][management-commands],
  `manage.py export_single_user`, which is a variant of the main server
  [export tool][export-and-import-tool], that exports a single Doer
...
backups, etc. [Doer Business](https://zulip.com/plans/#self-hosted) and [Doer
...
customer of Doer Cloud, you operate as the controller when using our
...
Doer Cloud, that are committed to handling the data in a compliant
manner.

Doer Cloud is considered a **data processor**. We act on the
...
providers like Amazon Web Services and Stripe to host Doer Cloud.
See [full list of subprocessors for Doer
Cloud](https://zulip.com/policies/subprocessors).

## Related articles

* [Doer Cloud privacy policy](https://zulip.com/policies/privacy)
* [Terms of Service](https://zulip.com/policies/terms)
* [Data Processing Addendum
  (DPA)](https://zulip.com/static/images/policies/Doer-Data-Processing-Addendum.pdf)
* [Subprocessors for Doer Cloud](https://zulip.com/policies/subprocessors)
