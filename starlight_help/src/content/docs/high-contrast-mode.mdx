...
By default, some visual elements in Doer (such as date/time stamps, certain
...
* [Accessibility in Doer](https://zulip.readthedocs.io/en/stable/subsystems/accessibility.html)
