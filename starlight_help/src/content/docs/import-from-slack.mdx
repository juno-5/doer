...
To import your Slack organization into Doer, you will need to take the
following steps, which are described in more detail below:

<Steps>
  1. [Export your Slack data](#export-your-slack-data).
  1. [Import your Slack data into Doer](#import-your-data-into-doer).
...
## Import your organization from Slack into Doer
...
<Tabs>
  <TabItem label="Doer Cloud (self-serve)">
    <Steps>
      ...
      1. Fill out the information to [create a new Doer Cloud
      ...
      1. If you're using a different registration email from your Slack account,
         ...
         account in the imported workspace, you can create a new Doer account.
      1. Set a password for your Doer account, and click **Submit**.
    </Steps>
  </TabItem>

  <TabItem label="Doer Cloud (via support)">
...
Whether you are using Doer Cloud or self-hosting Doer, here are few notes to keep
...
* Slack's user roles are mapped to Doer's [user
  roles](/help/user-roles) in the following way:
  | Slack role              | Doer role    |
  | ----------------------- | ------------- |
...
To prepare your organization for transitioning to Doer, follow the [guide on
