...
A **user** is an individual's account within a Doer
[organization](/help/join-a-doer-organization). Administrators can
...
Doer lets users and organization administrators configure the following
