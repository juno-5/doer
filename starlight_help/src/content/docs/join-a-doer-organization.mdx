---
title: Joining a Doer organization
---

import {Steps} from "@astrojs/starlight/components";

By default, Doer organizations require an invitation to join.
...
Invitations to Doer organizations often come by email. Look for an email
from Doer. It may take a few minutes for the invitation email to reach your
inbox.
...
* If you are joining multiple Doer organizations, we recommend
  using the [Doer Desktop app](/apps/). The desktop app makes it easy to
  [switch between different organizations](/help/switching-between-organizations).
* If your company uses single sign-on (SSO) authentication for Doer,
  these instructions may not apply. Try going to your company's Doer URL
