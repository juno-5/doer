...
Everything in Doer can be done with the mouse, but mastering a few keyboard
...
reference in the Doer app to add more to your repertoire as needed.
...
* **Insert link**: `[Doer website](https://doer.org)` or <kbd>Ctrl</kbd> +
...
A summary of the keyboard shortcuts above is available in the Doer app.
