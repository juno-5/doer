...
import PanelLeftIcon from "~icons/doer-icon/panel-left";
import PanelLeftDashedIcon from "~icons/doer-icon/panel-left-dashed";
import SquarePlusIcon from "~icons/doer-icon/square-plus";

The left sidebar in the Doer web and desktop apps helps you navigate your
