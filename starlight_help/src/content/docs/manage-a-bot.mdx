...
import DownloadIcon from "~icons/doer-icon/download";
import RefreshIcon from "~icons/doer-icon/refresh-cw";
import UserCogIcon from "~icons/doer-icon/user-cog";

Doer lets you manage the properties of any bot for which you are the owner.
