...
Doer automatically keeps track of which messages you have and haven't read.
Unread messages have a line along the left side, which fades when the message
gets marked as read.

Doer offers tools to manually mark one or more messages as read, and you can
...
You can choose how messages are automatically marked as read in the Doer web
...
* **Only in conversation views**: In Doer, a **conversation** is a [direct
