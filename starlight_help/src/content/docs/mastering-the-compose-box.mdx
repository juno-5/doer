...
import ChevronRightIcon from "~icons/doer-icon/chevron-right";

Here is an overview of all the information and actions you can take in Doer's
compose box.
...
When composing a message, Doer lets you view a different
...
Doer lets you jump to the [conversation](/help/reading-conversations) you're
