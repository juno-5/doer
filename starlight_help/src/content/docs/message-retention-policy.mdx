...
By default, Doer stores messages indefinitely, allowing full-text
search of your complete history.

Doer supports configuring both a global organization-level message
...
In Doer Cloud, message retention policies are available on the Doer
Cloud Standard and Doer Cloud Plus [plans](https://zulip.com/plans/),
...
* Deleted messages are preserved temporarily in a special archive.  So
  ...
  meant to preserve, contact Doer support promptly for assistance with
  restoration.  See the [deletion
  documentation](/help/delete-a-message#delete-a-message-completely) for
  more details on precisely how message deletion works in Doer.
