---
title: Installing the Doer mobile apps
---

import {Steps, TabItem, Tabs} from "@astrojs/starlight/components";

Doer's native Android and iOS apps make it easy to keep up while on the go,
...
<Tabs>
  <TabItem label="Android">
    **Google Play**
    ...
    <Steps>
      1. Download [Doer for Android](https://zulip.com/apps/android).
    ...
    **Download an APK**
    ...
    <Steps>
      1. Download [the latest release](https://github.com/doer/doer-flutter/releases/latest).
      1. Open the app on your device.
    </Steps>
  </TabItem>
  ...
  <TabItem label="iOS">
    <Steps>
      1. Download [Doer for iOS](https://zulip.com/apps/ios).
      1. Open the app on your device.
    </Steps>
  </TabItem>
</Tabs>
...
Doer replaced the legacy mobile app with a [new mobile
...
<Tabs>
  <TabItem label="Android">
    **Download an APK**
    ...
    <Steps>
      1. Uninstall the Doer app, if it's already installed.
      1. Download [the legacy app](https://github.com/doer/doer-mobile/releases/latest)
         APK file.
