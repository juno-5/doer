...
Doer can be configured to send [mobile](/help/mobile-app-install-guide)
...
Doer Server 11.0+ and Doer Cloud support end-to-end encryption for mobile push
notifications. Support is [coming soon][e2ee-flutter-issue] to the Doer mobile
...
[e2ee-flutter-issue]: https://github.com/doer/doer-flutter/issues/1764
...
You can customize whether or not Doer will send mobile push
notifications while you are actively using one of the Doer apps.
...
Next, test Doer push notifications on your mobile device.

<Tabs>
  <TabItem label="Mobile">
    <Steps>
      1. [Download](https://zulip.com/apps/) and install the Doer mobile app if you
         have not done so already.
      1. If your Doer organization is self-hosted (not at `*.zulipchat.com`),
      ...
      1. Ask *another* user (not yourself) to [send you a direct
         message](/help/starting-a-new-direct-message). You should see a Doer message
...
delivery of mobile notifications to apps like Doer. If you're having issues
with Doer notifications on your Android phone, we recommend Signal's excellent
...
<DoerNote>
  These instructions do not apply to Doer Cloud organizations (`*.zulipchat.com`).
</DoerNote>

To enable push notifications for your organization:

<Steps>
  1. Your server administrator needs to register your Doer server with the
     [Doer Mobile Push Notification
