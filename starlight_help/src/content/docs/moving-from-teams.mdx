...
<Tabs>
  <TabItem label="Import from Teams">
    <FlattenedSteps>
      <SetUpServerStep />
...
<FlattenedSteps>
  ...
  1. Take advantage of Doer's [native integrations ecosystem](/integrations) by
     connecting Doer with the tools you use.
</FlattenedSteps>
...
<FlattenedList>
  ...
  * In Doer, it's easy to have many conversations in parallel without losing
    ...
    DMs.
  * Doer allows users to fine-tune their notification settings. Make sure you're
...
* [Import from Microsoft Teams](/help/import-from-microsoft-teams)
