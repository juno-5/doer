...
that you can do when you're logged in. You should treat your Doer API key as
...
* Losing a device where you're logged in to Doer (e.g., a cell phone or laptop).
...
Changing your API key will immediately log you out of Doer on all devices.
