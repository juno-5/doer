...
With privacy in mind, Doer lets you [control][configure-personal-read-receipts]
...
## Configure whether Doer lets others see when you've read messages

Doer supports the privacy option of never sharing whether or not you have read
...
[configure-personal-read-receipts]: /help/read-receipts#configure-whether-doer-lets-others-see-when-youve-read-messages
