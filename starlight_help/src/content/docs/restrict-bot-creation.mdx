...
Doer lets you create three types of [bots](/help/bots-overview):

* **Incoming webhook bots**, which are limited to only sending messages into Doer.
...
<FlattenedSteps>
  ...
  1. Under **Other permissions**, configure **Who can create bots that send messages into Doer**.
...
* [Incoming webhooks](https://zulip.readthedocs.io/en/latest/webhooks/incoming-webhooks-overview.html)
