...
import VideoCallIcon from "~icons/doer-icon/video-call";
import VoiceCallIcon from "~icons/doer-icon/voice-call";

Doer makes it convenient to add a video or voice call link to any message,
...
<Tabs>
  ...
  <TabItem label="Mobile">
    ...
    GitHub](https://github.com/doer/doer-flutter/issues/1000). If
...
## Unlink your Zoom account from Doer

If you linked your Zoom account to Doer, and no longer want it to be connected,
you can unlink it.

<Steps>
  1. Log in to the [Zoom App Marketplace](https://marketplace.zoom.us/), and
     select **Manage**.
  1. Select **Added Apps** and click the **Remove** button next to the Doer app.
  1. Click **Confirm**.
</Steps>
