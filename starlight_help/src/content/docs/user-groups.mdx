...
import SubscriberCheckIcon from "~icons/doer-icon/subscriber-check";
import SubscriberPlusIcon from "~icons/doer-icon/subscriber-plus";
...
organization's structure in Doer's permissions system.
...
<Tabs>
  <TabItem label="Desktop/Web">
    <FlattenedSteps>
      ...
      1. Click the **join group** (<SubscriberPlusIcon class="doer-unplugin-icon subscriber-plus-icon" />) icon to the left of a user group to
...
<Tabs>
  <TabItem label="Desktop/Web">
    <FlattenedSteps>
      ...
      1. Click the **leave group** (<SubscriberCheckIcon class="doer-unplugin-icon subscriber-check-icon" />) icon to the left of a user group to leave the
         group, if you have
         [permission](/help/manage-user-groups#configure-group-permissions) to do so.
    </FlattenedSteps>
  </TabItem>
