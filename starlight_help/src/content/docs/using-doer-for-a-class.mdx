---
title: Using Doer for a class
---

import DoerTip from "../../components/DoerTip.astro";

Welcome to Doer! This pages offers some tips for [using Doer for a
class](https://zulip.com/for/education/).  If this is your first time using Doer, we
recommend checking out [Getting started with
Doer](/help/getting-started-with-doer) to get oriented.

Doer works great as the communication hub for your class, providing a
single place for:
...
* **#Unit 3: Sorting algorithms** > **lecture notes**: Here are the notes
  from today’s lecture. [lecture notes 10/2.pdf](/help/using-doer-for-a-class) You can view a recording of the lecture [here](/help/using-doer-for-a-class).
...
In Doer, channels determine who receives a message. Topics are
...
Doer works best when each conversation has its own topic. When you
...
Doer will show auto-complete suggestions for existing topics as you
...
Doer works great for virtual office hours! With a dedicated thread
