...
import CopyIcon from "~icons/doer-icon/copy";

Doer shows previews of attached images and videos, unless previews are
...
video. Doer also makes it convenient to browse all images and videos
  ...
  <TabItem label="Desktop/Web">
    <Steps>
      ...
      1. You can interact with the video.
         ...
         * **Download** the video if it was uploaded to Doer
    ...
    <DoerTip>
      ...
      rather than viewing it in the Doer app.
    </DoerTip>
  ...
  <TabItem label="Mobile">
    <Steps>
      1. Tap a video thumbnail, link, or file name to open the video in your device's
         default browser.
      1. You can switch back to the Doer app once you are done.
    </Steps>
  </TabItem>
</Tabs>
...
In the Doer desktop or web app, you can browse the images and videos in
