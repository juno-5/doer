...
Bots in the main
[`python-doer-api`](https://github.com/doer/python-doer-api/tree/main/doer_bots/doer_bots/bots)
...
[`helloworld`](https://github.com/doer/python-doer-api/tree/main/doer_bots/doer_bots/bots/helloworld) bot.

```python
from doer_bots.test_lib import StubBotTestCase
...
* To test a bot in [Doer's bot directory](https://github.com/doer/python-doer-api/tree/main/doer_bots/doer_bots/bots):
...
*The code for the bot testing library can be found [here](https://github.com/doer/python-doer-api/blob/main/doer_bots/doer_bots/test_lib.py).*

### Testing bots with config files

Some bots, such as [Giphy](https://github.com/doer/python-doer-api/tree/main/doer_bots/doer_bots/bots/giphy),
...
For an example, check out the [giphy bot](https://github.com/doer/python-doer-api/tree/main/doer_bots/doer_bots/bots/giphy).
...
Check out our [bots](https://github.com/doer/python-doer-api/tree/main/doer_bots/doer_bots/bots)
