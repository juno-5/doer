* Many organizations find that with Doer, there’s no longer a reason to use
  ...
  @-mentions, and more.
* Because Doer further organizes messages into conversations labeled with
...
* With conversations organized by topic, you can review prior discussions to
  ...
  becomes a knowledge base. Should it be standard practice to link to Doer
  conversations from docs, issue trackers, etc. for additional context?
* Using Doer, you can discuss complex topics and make decisions with input
