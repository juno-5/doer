...
* You are a paid [Doer Cloud Standard](https://zulip.com/plans/) or [Doer
...
* You have authority to read members' [direct messages](/help/direct-messages).
  Typically, this will be because your Doer organization is administered by a
  corporation, and you are an official representative of that corporation.

By requesting and executing this export, you will assume full legal
