...
<TabItem label="Imported organizations">
  <Steps>
    1. [Configure allowed authentication
       methods](/help/configure-authentication-methods). Doer offers a
    ...
    1. Share a link to your Doer organization, which is
       `https://your-org.zulipchat.com` on Doer Cloud.
    1. *(optional)* To log in with an email/password, users will need to set their
       ...
       * Automatically send password reset emails to all users in your
         organization. If you imported your organization into Doer Cloud, simply
