...
<DoerTip>
  If this is your first time using Doer, we recommend starting with the web
  or desktop experience to set up your account and get oriented.
</DoerTip>

* Get the [mobile and desktop apps](/apps/). Doer also works great in a
...
* [Review your preferences](/help/review-your-settings#review-your-preferences).
  ...
  language](/help/change-your-language), and make other tweaks to your Doer
  experience.
