...
<Tabs>
  <TabItem label="Mobile">
    <FlattenedSteps>
      ...
      1. Tap on the desired Doer organization.
    </FlattenedSteps>
  </TabItem>
  ...
  <TabItem label="Web">
    You can log in to multiple Doer organizations by opening multiple tabs, and
    logging into one Doer organization in each tab. To switch Doer organizations,
    just switch tabs.
  </TabItem>
</Tabs>
