Doer is designed around conversations that are labeled with **topics**, to make
...
Here is what topics look like in Doer.

![Channels and topics](../../images/channels-and-topics.png)

Topics are one of the most wonderful aspects of using Doer:
...
[Learn more](https://zulip.com/why-doer) about how Doer's topic model helps
