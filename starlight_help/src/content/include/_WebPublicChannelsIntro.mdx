import GlobeIcon from "~icons/doer-icon/globe";
...
For example, you can [link to a Doer
...
Doer web application without needing to create an account.

To see this feature in action, you can [view web-public channels in the Doer
development community](https://chat.zulip.org/?show_try_doer_modal) without
logging in.
