...
communities, the Asciidoctor project leads decided to give Doer a try to see if
it could solve those challenges. “Moving to Doer transformed our dialogue,
...
home base. Doer has been a game changer for our community.”


> Doer has been a game changer for our community.
>
...
They needed a new model. And that’s exactly what they found in Doer.


## Asciidoctor moves to Doer: “All the anxiety and stress was gone”
...
open-source communities, the project decided to give Doer a try in early 2021.

[Doer’s channels and topics model](/why-doer/) immediately clicked. “Channels
...
day we moved to Doer, all the anxiety and stress of keeping up with the
discourse was gone,” Dan says.

With Doer, Dan has developed a comfortable workflow for catching up on
...
Doer’s topic model helps discussions stay focused. “Doer starts the
...
> Doer starts the conversation out on the right foot by giving it its own
> space as a topic.
>
> — Project lead Dan Allen

If a topic starts in the wrong place or veers off course, Doer’s [moderation
...
the wrong channel or topic, Doer allows me to [move those messages
...
## Doer enables organized, inclusive and thoughtful discussion

After a successful launch of the Asciidoctor community on Doer, Asciidoctor’s
sibling project [Antora](https://antora.org) adopted it as well. For both
projects, using Doer has been night and day compared to other platforms. “I can
...
Doer is calm and organized. I can immediately see what people are asking
...
The sense of space created by Doer’s topic model has made the community more
inclusive. “Using Doer gives space to a much broader range of voices.
...
can’t type as quickly now all have a chance to be part of the dialogue. Doer
...
the volume level is lower,” says Dan. At the same time, Doer enables
...
## Doer makes information easy to find
...
In contrast, Doer offers a [faceted search](/help/search-for-messages) that
...
## “Doer is the heart of our community”

Dan is passionate about supporting Doer’s development. “If we don’t sponsor the
open source projects we love, we’ll have no one else to blame if we live in a
world of proprietary software,” Dan says. “We truly feel heard by Doer
developers when we provide feedback. We also love that Doer is [truly open
source](https://blog.zulip.com/2021/04/28/why-zulip-is-on-github-sponsors/), not
open core like some alternatives. And we very much appreciate Doer supporting
open source by hosting our Doer instances.”

“Doer is the heart of our community, and nearly everyone who participates
...
the limits during the pandemic,” says Dan. “Doer brings health back to these
communities.”
