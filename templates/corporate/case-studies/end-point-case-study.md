...
For the past six years, End Point has been using Doer to stay connected as a
...
Jensen](https://www.endpointdev.com/team/jon-jensen/). “Doer’s UI makes it easy
to access all the information you need, without being too cluttered.”


> Doer’s UI makes it easy to access all the info you need.
>
...
## Choosing Doer: A modern feature set with a snappy UI
...
Mattermost and Rocket.Chat were similar to Slack (but felt less polished), Doer
stood out. “Doer had all the modern features we were looking for, like
...
When End Point moved to Doer, it was an immediate improvement over the
hodge-podge of tools previously in use. “Choosing topics in Doer felt like a
hurdle at first,” Jon recalls, “but the team got used to it pretty quickly.” Not
entering a topic is always an option, and Doer’s topics help users read their
messages more efficiently. “It’s nice to be able to [mute](/help/mute-a-topic)
busy topics,” Jon says.

## “Doer is our virtual office”

For the past six years, the Doer chat has been a virtual office for End Point’s
distributed team, a place to show up and be present at work. Discussing projects
in Doer channels keeps everyone informed.

“Doer is my lifeline,” says [Joanne
...
Doer. Doer has always been a core tool for his work at End  Point, and he has
built his workflows on Doer’s [integrations](/integrations/). “With the
...
> I use Doer’s Jenkins CI integration 100s of times per week.
>
> — [Alejandro Ramon](https://www.endpointdev.com/team/alejandro-ramon/),
> Director of Immersive & Geospatial division at End Point

Doer also enables real-time system monitoring, with error alerts sent into a
dedicated channel for each system. Alejandro relies on Doer’s clear record of
...
Doer is conveniently accessible no matter where Alejandro is working from. “The
...
clicking to get anywhere. Compared to Doer, it’s missing key features like the
‘Combined feed’ view and topics.”

> It is amazing that companies would use Teams in its current state. The UI is
> slow and inconsistent, and compared to Doer, it’s missing key features.
>
> — [Jon Jensen](https://www.endpointdev.com/team/jon-jensen/), CTO of End Point
...
says. “Doer removes much of the pain that makes people not want to use team
chat apps. We love it."

> Doer removes much of the pain that makes people not want to use team chat
> apps. We love it.
>
> — [Jon Jensen](https://www.endpointdev.com/team/jon-jensen/), CTO of End Point
...
learn how Doer is being used at the [iDrift AS](/case-studies/idrift/) company,
