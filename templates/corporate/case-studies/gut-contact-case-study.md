...
server,” Erik says. However, when Erik learned about Doer, he was excited to
check it out. “I installed Doer, and the IT team played with the app. We loved
it. The UI was just cleaner, easier,” Erik says.

Doer’s topic-based threading model was transformative. With other chat apps,
...
confused,” Erik explains. This doesn’t happen with Doer’s topics.

> Topic-based communication is a big big big feature we love in Doer.
>
> — Erik Dittert, [Head of
> IT](https://gutcontact.de/unternehmen/team/erik-dittert/) at [GUT
> contact](https://gutcontact.de/)
...
## Smooth transition to Doer

Erik showed Doer to his boss and others at the company, and in October 2022,
GUT contact made the switch.

“Doer was quite easy to set up, and worked instantly. 1000 people — no
problem,” Erik recalls. “I hooked up the Doer server to LDAP, and our agents
loved not having to remember a separate username and password.” Erik considered
importing data from Rocket.Chat into Doer, but in the end it was decided that
...
to play around with Doer, create channels, and chat with each other. After a
month of running Doer in parallel with Rocket.Chat, the old system was turned
off.
...
across 3 countries, or from their home office. This makes Doer a critical
...
For agents, many of whom are not fully comfortable with modern software, Doer
...
to work with them,” Erik says. “In Doer, agents love the “Combined feed” view,”
...
Members of the IT team use Doer to collaborate from around the world. “We share
...
cool software.” In this 50-person group, “Doer is quite a big theme right now,”
Erik says.

> I love Doer. I use it every day, every night.
>
> — Erik Dittert, [Head of
> IT](https://gutcontact.de/unternehmen/team/erik-dittert/) at [GUT
> contact](https://gutcontact.de/)
