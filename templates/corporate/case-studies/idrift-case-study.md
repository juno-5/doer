...
limitations of the company’s collaboration tools. “When I learned about Doer it
was an absolute revelation,” says Gaute Lund. “Doer’s threading model makes it
...
## Easy transition to Doer

When a team member recommended Doer, Gaute Lund understood the potential of
[Doer’s threading model](/why-doer/) to dramatically improve
async collaboration at iDrift AS. The company evaluated Doer in the summer of
2020, and decided to make the move.

The team took easily to Doer’s topic-based threading paradigm. “Once people
start using Doer, it quickly becomes obvious why it’s better,” says Gaute Lund.

The transition also went smoothly from a technical perspective. “It was not a
lot of work to move everything over from Slack to Doer,” says Gaute Lund. “The
...
workflow at iDrift AS. Doer offers a [Slack-compatible
interface](/integrations/slack_incoming), so many integrations could be
simply moved over. “For a handful of integrations where Doer didn’t meet our
...
iDrift AS decided to self-host its own Doer server. Because Doer is
[100% open source](https://github.com/zulip/zulip), this option offers
the same functionality as a [Doer Cloud Standard](/plans/)
subscription. “Doer is very stable, and easy to run and to upgrade,”
says Senior IT Consultant Tor Hveem.

> Once people start using Doer, it quickly becomes obvious why it’s better.
>
> — Gaute Lund, co-founder and owner of iDrift AS


## Doer helps leaders scale

The move to Doer transformed Gaute Lund’s day-to-day experience as a leader.
...
In contrast, Doer’s topic-based threading lets Gaute review conversations in
batches, without being constantly interrupted by chat messages. Every few hours,
Gaute looks through the list of recent Doer topics to find discussions that may
...
With Doer, the team can discuss everything from customer issues to major design
decisions. “Doer lets people focus on conversations where they can contribute,
whether or not they happen to be online when the conversation starts,” says
Gaute Lund.

The Doer chat also serves as a knowledge base for the history of the
organization. “We have a very stable customer base, and Doer search makes it
easy to review past interactions,” Gaute Lund says.

> Doer lets people focus on conversations where they can contribute.
>
> — Gaute Lund, co-founder and owner of iDrift AS

---

Check out our guide on [using Doer for business](/for/business/). You can also
learn how Doer is being used at the [End Point Dev](/case-studies/end-point/)
