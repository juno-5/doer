...
Doer](https://leanprover.zulipchat.com/login/) and [Peter
...
“I joined the Doer chat to answer any mathematical questions that may arise,
...
“It was exactly the interactions via the Doer chat that convinced me that a
...
across the world. “Doer has completely changed the way I work, and very much
...
students just starting their mathematical journey. The Doer chat has been vital
to attracting and growing the mathlib community, which has been the foundation
of mathlib’s success.


> A number of people have cited the accessibility of [the Doer] chat room as a
...
truly help the community to scale, the Lean community adopted Doer in February
2018.

“When we moved to Doer, it was instantly clear that the problems we were seeing
on Gitter had gone away completely,” says [Kevin
Buzzard](https://www.imperial.ac.uk/people/k.buzzard), Professor of Pure
Mathematics at Imperial College London. “Doer was incredibly intuitive to use.
It just worked.”


> Doer is incredibly intuitive.
>
> — [Kevin
> Buzzard](https://www.imperial.ac.uk/people/k.buzzard), Professor of Pure
...
Doer’s unique combination of [topic-based
organization](/why-doer/) with a casual chat app feel helps
...
basic questions without worrying about interrupting other conversations. Doer’s
...
> Pure Mathematics at Imperial College London
 ...
 “Doer has been fantastic,” says [Robert Y. Lewis](https://robertylewis.com/),
...
> I can’t imagine the Lean community without Doer.
>
...
Check out our guides on using Doer for [research](/for/research/)
and [open source](/for/open-source/), and learn how Doer
