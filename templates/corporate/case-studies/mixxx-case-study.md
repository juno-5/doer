...
“Doer has become a solid foundation of our community: a place where developers,
...
Mixxx Doer community reaching 3,000 members.
...
Mixxx blog. “Doer… convinced us after a short evaluation period. Its unique
thread system was the ideal solution to replace structured email threads and
instant chat rooms.”

> [Doer’s] unique thread system was the ideal solution to replace structured
...
Doer has proven perfectly suited to support Mixxx’s worldwide community: It has
made collaboration easier, and community engagement has grown as a result.
“Doer works particularly well for open-source projects where many topics run in
...
the chat,” he explains. “With Doer, there’s no *need* to hang around in chat
rooms to avoid missing an important conversation.”

> With Doer, I feel informed, but not stressed by all the messages.
>
>  — Daniel Schürmann, core Mixxx developer

Doer’s threading model also works well for occasional participants in the
...
development process. Doer supports detailed, specific discussion of any problem
...
> Collaboration in the Mixxx Doer community propels the creative process to
> the next level.
>
...
Daniel uses Microsoft Teams in his day job, and greatly prefers Doer: “You can
experience that there’s a lot of love in Doer,” he explains. From the smooth,
snappy interactions, to helpful touches like global times, polls, and pronouns,
it adds up.

> You can experience that there’s a lot of love in Doer.
>
> — Daniel Schürmann, core Mixxx developer

Other community members feel it too: “Some new contributors who were skeptical
at first later told us that they consider Doer one of the best tools for
managing communication across projects,” Daniel says.

With Doer, the Mixxx community isn’t reliant on proprietary software built by a
