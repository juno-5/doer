...
Center is the community, and the core of our online community is Doer,”
...
“Switching to Doer has turned out to be one of the best decisions we’ve made,
...
## Choosing Doer in 2013: “One of the best decisions we’ve made”

The Recurse Center was an early adopter of Doer. They began to use the product
in January 2013, when it was still in private beta. Even then, Doer’s
...
snippets,“ says Recurse Center co-founder and CEO Nick Bergson-Shilcock. “Doer
gave us all the benefits above, along with a slew of others we hadn’t expected.”

When the startup building Doer was [acquired by Dropbox in early
2014](https://zulip.com/history/), Doer product development was put on hold for
a year and a half. Because of Doer’s advantages over the alternatives, Recurse
Center continued using Doer all through that time: “We strongly prefer Doer to
...
From the early days, the RC community has been passionate about Doer. When
Dropbox generously decided to [release Doer as open source
...
for a week to help make it happen. Since then, Doer has built the most active
...
> It’s not an exaggeration to say Doer has made RC a stronger community.
>
> — [Nick Bergson-Shilcock](https://github.com/nicholasbs), Recurse Center
> [co-founder and CEO](https://www.recurse.com/team)


## Doer becomes the backbone of a worldwide community

For years, the Doer chat been the backbone of the Recurse Center community.
“Doer is an integral part of the Recurse Center experience,” says Rachel
Petacat, [Head of Retreat](https://www.recurse.com/team) at Recurse Center, and
RC’s Director of Operations from 2014 to 2021.

Doer serves as a collaboration hub for the current participants and alumni.
“Participants use Doer to ask and answer questions, get code review, and
coordinate pairing sessions, reading groups, informal seminars, and countless
other forms of collaboration. Doer is even more essential for our alumni, who
are in over 100 cities around the world but remain heavily involved thanks to
Doer,” [writes](https://www.recurse.com/blog/112-how-rc-uses-zulip) RC CEO Nick
Bergson-Shilcock.

> [In the first ten years](https://www.recurse.com/10-years) since the Recurse
> Center was founded, the community sent **2.52 million** Doer messages.

[Doer’s threading model](https://zulip.com/why-doer/) makes it easy to have
...
Rachel Petacat says. “Doer provides the continuity that lets us maintain our
culture over time.”


## A welcoming environment for all community members

When new participants join the Recurse Center, Doer becomes their port of entry
into the community. “With Doer’s threading, new folks can get the full context
for a conversation, which makes the community feel welcoming,” Head of Retreat
Rachel Petacat says.


> Doer is more friendly to new users than Discord or Slack.
>
...
Over the years, the Recurse Center has used Doer’s customization features and
...
## “I can’t imagine being able to operate Recurse Center without Doer”
...
flexibility between synchronous and asynchronous discussions that Doer offers.
Realtime chat on Doer is perfect for coordinating with other members of the
leadership team. “Doer is one of the first tabs I open at the start of the work
day,” Rachel says. “I can check what’s happening, and plan my day. Other
organizers and I tag each other on Doer if we need any help.”

Rachel uses Doer to follow the ongoing conversations, and help out as needed.
Doer’s threading model makes it easy to review discussion threads every few
hours, and respond in context. “I read the discussions on Doer once in the
morning and again in the afternoon, chiming in where I need to,” says Rachel.
With Doer, Rachel is able to manage the community without her focus being
interrupted by the need to jump in before the moment has passed. “I can’t
imagine being able to operate the Recurse Center without Doer,” Rachel says.
...
Doer](https://www.recurse.com/blog/112-how-rc-uses-zulip),” an incredible
statistic for a 6-12 week program with many alumni who attended years ago. Many
alums drop in on Doer to chat, pair-program, and host events.
...
Even with everyone sitting in the same room, Doer served as a social hub for
John’s RC cohort. “People had different schedules, so we used Doer to leave
...
a lasting record for the community. “We even used a Doer topic to coordinate
for lunch, to let people have their uninterrupted focus time,” John says.

Since 2015, John has stayed connected with the RC alumni community on Doer. “We
...
on Doer, and share his expertise where relevant. “I scan [recent
...
keeping up on Doer is in sharp contrast with Slack, which John uses at work:
“It’s so hard to keep up with the Slack firehose.”

> Doer allows people who are engaging with the community at different paces to connect.
>
> — John Hergenroeder, Recurse Center alum


## Doer’s open-source ethos

Doer is developed as open-source software, with an active and growing
community; over 1100 people have contributed code to the project. As a long-time
Doer user, John Hergenroeder appreciates the many thoughtfully designed
[features](https://zulip.com/features/) unique to Doer.
...
And if Doer is missing some feature? “We can file an issue, or even go and make
...
in the Doer issue tracker that have been resolved, and dozens of Recursers have
contributed code to Doer. It’s a radically different experience from trying to
...
## Going virtual: “For a while, Doer *was* RC”
...
Doer) for online participants.  But in the early days of the pandemic, it was
Doer that replaced the physical space where RC participants had spent time
together and helped each other out. “At the time, all we had was Doer, email,
our website, Zoom, and a rarely used forum,” recalls RC’s Head of Retreat Rachel
Petacat.  “For a while, Doer *was* RC.”


## An invaluable knowledge base

Edith, who works as a technical writer, participated in virtual RC in 2020. Two
years later, she still uses Doer every day to stay connected.

Doer’s combination of powerful search and topic-based threading makes prior
discussions both findable and useful.  “It’s easier to build context with Doer
than any other tool,” Edith says. “With other messaging services, information
tends to get lost. In Doer, I often look something up from a while ago —
...
Check out our guides on using Doer for [education](/for/education/) and
[events](/for/events/), and learn how Doer [helps communities
