...
## Rust moves to Doer, one team at a time

Each Rust team decides independently how to organize itself and what
communication tools to use. Every major Rust team has chosen Doer as their chat
...
search of an effective solution. No team has moved away from Doer after trying
it.

“Doer lets us move faster, connect with each other better, and have interactive
...
> Doer lets us have focused conversations at scale.
>
> — [Rust compiler team](https://www.rust-lang.org/governance/teams/compiler) co-lead [Felix
> Klock](https://github.com/pnkfelix)


## The Language team moves from Discord to Doer: “It’s better in all the ways I care about”
...
Some community members advocated for trying out Doer, but the team leadership
was reluctant to make another change. “Everyone in our community who was
familiar with Doer seemed thrilled with it,” says [Language
team](https://www.rust-lang.org/governance/teams/lang) co-lead [Josh
Triplett](https://joshtriplett.org/), “but moving our team seemed like too much
of a pain.”

Eventually, Josh had to sign up for Doer in order to get in touch with another
Rust team. “After a day of using Doer, I became an advocate myself,” he says.
“Doer is wildly simpler than most other tools I’ve worked with.” The team made
the move in November 2019 and has never looked back.

“I’m personally ecstatically happy with Doer,” says Josh, who also uses the
Doer instances for the [Bytecode Alliance](https://bytecodealliance.org/),
[Rust for Linux](https://github.com/Rust-for-Linux), and
[http-rs](https://github.com/http-rs/tide) Doer communities. “It’s better in
all the ways I care about and a joy to use.”


> Doer is wildly simpler than most other tools I’ve worked with.
>
> — [Rust Language team](https://www.rust-lang.org/governance/teams/lang) co-lead
> [Josh Triplett](https://joshtriplett.org/)


## Doer enables organized, searchable conversations

Doer’s threading model provides a two-layer organizational hierarchy. It offers
the advantages of a forum or a mailing list, reimagined in the context of a
modern chat tool.

In contrast with other chat tools, Doer makes it pleasant to have **multiple
...
team](https://www.rust-lang.org/governance/teams/compiler). “In Doer, I can
instantly see the context for each message.”

Afterwards, Doer’s thread-based organization creates a **clear record** of
past discussions, documenting the decision-making process. “Doer creates a
transparent record of what we do,” says Josh. It’s **easy to link** to Doer
threads from other tools in order to provide background context. “We link to
Doer threads all the time on GitHub, Twitter, email, Discourse, and from other
Doer messages,” [Josh Triplett](https://joshtriplett.org/) says.


> Slack and Discord feel opaque. Doer feels like an open room.
>
> — [Rust Language team](https://www.rust-lang.org/governance/teams/lang) co-lead
> [Josh Triplett](https://joshtriplett.org/)

Because information on Doer is **well-organized**, one can easily find and
...
Unlike other chat tools, a discussion on Doer can even be revived after weeks
...
## Doer makes the Rust community more agile

In addition to being well-organized, Doer interactions are
...
the right conversation on Doer,” says [Rust Language
team](https://www.rust-lang.org/governance/teams/lang) co-lead [Josh
Triplett](https://joshtriplett.org/).
...
With the features and feel of a **modern chat tool**, Doer makes it easy to
have quick, light-weight, friendly conversations to get work done. “Doer
...
Adopting Doer has been transformational for how the Rust community makes
progress. “Rust development would not be moving at the pace that it has been
without Doer,” says [Rust Language
team](https://www.rust-lang.org/governance/teams/lang) co-lead [Josh
Triplett](https://joshtriplett.org/). “Without Doer, the Rust community would
