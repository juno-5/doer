...
Discord and Doer.  “I chose Doer for several reasons, especially the
threaded model (which I find sorely lacking in other chat apps), and
the TeX integration.”

From Spring 2020 through Spring 2021, the [Doer
...
little easier. Having set up Doer Cloud for his three graduate-level
...
to UCSD,” Kiran says. A Doer poll showed participants from as far as
the Middle East, Southeast Asia and Oceania.

“Doer became a central hub for asynchronous Q&A and posting Zoom
links for lectures, whiteboard PDFs, and announcements,” Kiran says.

With students logging in at all hours of the day, Doer’s topic model
was key to making sure everyone could find the materials they needed
and participate in the discussions. “Doer’s topics, and the ability
to change the topic of someone else's message, has made it much easier
for me to keep things coherent,” says Kiran.


## Doer has what you need

Beyond topics, Doer’s rich functionality smoothed out made many
aspects of remote communication. Here is what Kiran has to say about
the benefits of just a few of Doer’s features:
...
use Doer as the main communication platform for my in-person classes
this coming year,” Kiran says.

Doer is also helping Kiran organize events for students, and create
communities for education and research. “I used Doer as the
...
Doer for the number theory research group at UCSD, where graduate
...
Doer is being used at the [Technical University of Munich](/case-studies/tum/)
