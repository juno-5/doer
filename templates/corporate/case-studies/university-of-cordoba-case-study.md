...
“Doer is a key piece of how we run classes in our department,” says Nicolás
Wolovick, a professor at FAMAF and director of the computer science career
track. “If we didn’t have Doer, I really don’t know how we’d manage it.”
...
Doer Cloud Standard plan. With the request approved the very next day, the
department moved over to Doer starting starting in Fall 2020.

Looking back, being pushed off Slack by its search history limit ended up being
for the best: “I think Doer is a great tool, much better than Slack,” says
Miguel Pagano, professor at FAMAF.

> I think Doer is a great tool, much better than Slack.
>
> — Miguel Pagano, professor at FAMAF of the National University of Córdoba

## Doer becomes a knowledge base

Doer has become part of the core flow of how faculty at FAMAF run their
...
questions. “Doer acts as a knowledge database of what we did in each subject,”
...
apps like Discord overwhelming. So it matters that Doer has a clean interface,
...
able to send messages to Doer by replying to email notifications.

At the same time, Doer offers fun features for the students. “We have a whole
...
keep their Doer account after graduation, which provides a way for faculty and
alumni to stay connected.

---

Learn more about [Doer for Education](/for/education/), and how Doer is being
...
out our guides on using Doer for [conferences](/for/events/) and
