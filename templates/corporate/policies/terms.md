...
Welcome to Doer. Please read on to learn the rules and restrictions that govern
...
you and **KANDRA LABS, INC.** (“Doer,” “we” and “us”). Your use of
...
Addendum](/static/images/policies/Doer-Data-Processing-Addendum.pdf).
...
Doer takes the privacy of its users very seriously; see our [Privacy
...
## What are the basics of using Doer?

To use some of the Services, you may be required to sign up for an account,
select a password and display name (“Doer Display Name”), and provide us with
...
your Doer Display Name a name that you do not have the right to use, or another
...
in use of the Services (each such organization, entity, or group, a “Doer
Organization”, and each administrator of a Doer Organization, a “Doer
Organization Administrator”), you represent and warrant that you are authorized
to agree to these Terms on such Doer Organization’s behalf and bind them to
these Terms (in which case, the references to “you” and “your” in these Terms,
except for in this sentence, refer to that Doer Organization).
...
You will not share your Doer account or password with anyone, and you must
protect the security of your Doer account, your password, and any other access
...
including notifications that Doer sends you (for example, via email or SMS).
...
Doer to send you information regarding your account or transactions with us,
which may include Doer using automated dialing technology to text you at the
wireless number you provided, and you agree to receive communications from
Doer, and you represent and warrant that each person you register for the
Services or for whom you provide a wireless phone number has consented to
receive communications from Doer.** You agree to indemnify and hold Doer
...
in a way that violates someone else’s (including Doer's) rights.
...
- Export Content via the official Doer API and distribute such Content for
...
You understand that Doer owns the Services. You won’t modify, publish,
...
## What about anything I contribute to the Services? Do I have to grant any licenses to Doer or to other users?
...
otherwise have permission to see them (for example, any member of your Doer
...
features, Doer may access, use, store, copy, process, adapt, distribute,
...
- People you send a Doer message to may view the message through the Services.
- Your Doer Organization Administrators may [export the Doer Organization’s
  data](/help/export-your-organization) for archival or backup purposes, or to
  import the data into a self-hosted Doer server.
- Messages on a web-public channel may be viewed by anyone on the Internet.

When you delete your Doer account, we will stop displaying your User
...
after you delete your Doer account. You understand and agree that it may not be
possible to completely delete that content from Doer's records, and that your
...
with the [Doer Rules of Use](/policies/rules). A violation of any of the Doer
...
* **Procedure for Reporting Copyright Infringements**.  If you believe that
   ...
   following information to Doer's Designated Agent to Receive Notification of
...
Please contact Doer's Designated Agent at the following address:
...
services that are not owned or controlled by Doer. When you access third-party
websites or use third-party services, you accept that there are risks in doing
so, and that Doer is not responsible for such risks.

Doer has no control over, and assumes no responsibility for, the content,
...
Services. In addition, Doer will not and cannot monitor, verify, censor or edit
...
Your interactions with Doer Organizations and/or individuals found on or
...
parties. You agree that Doer shall not be responsible or liable for any loss or
...
users and any third party, you agree that Doer is under no obligation to become
involved. In the event that you have a dispute with one or more other users, you
release Doer, its directors, officers, employees, agents, and successors from
...
## Will Doer ever change the Services?
...
Doer is also free to terminate (or suspend access to) your use of the Services
or your account for any reason at our sole discretion, including your breach of
these Terms. Doer has the sole right to decide whether you are in violation of
...
property of Doer or third parties.
...
### I use the Doer App available via the Apple App Store – should I know anything about that?
...
* (a) Both you and Doer acknowledge that the Terms are concluded between you and
   Doer only, and not with Apple, and that Apple is not responsible for the
...
* (f) You acknowledge and agree that Doer, and not Apple, is responsible for
...
* (g) You acknowledge and agree that, in the event of any third-party claim that
   ...
   third party’s intellectual property rights, Doer, and not Apple, will be
...
* (i) Both you and Doer acknowledge and agree that, in your use of the
...
* (j) Both you and Doer acknowledge and agree that Apple and Apple’s subsidiaries
...
*Warranty Disclaimer.* Doer and its licensors, suppliers, partners, parent,
...
and agents, and each of their respective successors and assigns (Doer and all
such parties together, the “Doer Parties”) make no representations or
warranties concerning the Services, including without limitation regarding any
Content contained in or accessed through the Services, and the Doer Parties
...
in, the Services. The Doer Parties make no representations or warranties
...
indemnify and hold the Doer Parties harmless from and against any and all
...
operation of law or otherwise) without Doer's prior written consent. We may
...
Doer and limits the manner in which you can seek relief from Doer. Both you
and Doer acknowledge and agree that for the purposes of any dispute arising out
of or relating to the subject matter of these Terms, Doer's officers,
...
* (b) *Costs of Arbitration*. The Rules will govern payment of all arbitration
  fees. Doer will pay all arbitration fees for claims less than seventy-five
  thousand ($75,000) dollars. Doer will not seek its attorneys’ fees and costs
  in arbitration unless the arbitrator determines that your claim is frivolous.

* (c) *Small Claims Court; Infringement*. Either you or Doer may assert claims,
...
* (d) *Waiver of Jury Trial*. YOU AND ZULIP WAIVE ANY CONSTITUTIONAL AND
  ...
  You and Doer are instead choosing to have claims and disputes resolved by
  ...
  very limited review by a court. In any litigation between you and Doer over
...
* (e) *Waiver of Class or Consolidated Actions*. ALL CLAIMS AND DISPUTES WITHIN
  ...
  actions is deemed invalid or unenforceable, neither you nor Doer is entitled
...
* (g) *Exclusive Venue*. If you send the opt-out notice in (f), and/or in any
  ...
  Doer to litigate any dispute arising out of or relating to the subject matter
  of these Terms in court, then the foregoing arbitration agreement will not
  apply to either party, and both you and Doer agree that any judicial
...
* (h) *Severability*. If the prohibition against class actions and other claims
  ...
  survive the termination of your relationship with Doer.
...
your activity in connection with the Services, provided that Doer may, in its
...
shall otherwise remain in full force and effect and enforceable. You and Doer
agree that these Terms are the complete and exclusive statement of the mutual
understanding between you and Doer, and that these Terms supersede and cancel
...
makes you an employee, agent, partner, or joint venture of Doer, and you do not
have any authority of any kind to bind Doer in any respect whatsoever.

Except as expressly set forth in the sections above regarding the Apple
Application and the arbitration agreement, you and Doer agree there are no
