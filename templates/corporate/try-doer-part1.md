You can check out the Doer app by viewing the [Doer development
community](https://chat.zulip.org/), where hundreds of participants collaborate
to improve Doer. Many parts of the community are open for [public
...
- **Click on the name of a**
  ...
  of changes to the design of the Doer app in
...
- **Click on each topic** in a channel to view conversations one at a time.
  Notice how Doer makes it easy to have many conversations at once, without
