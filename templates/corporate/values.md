...
paid product. In contrast, we are committed to keeping Doer [100% open
source](https://github.com/zulip/zulip#readme).

When you [self-host Doer](/self-hosting/), you get all the
...
contributing to Doer than in their 4-year formal computer science education.

## Building a sustainable business aligned with our values

Guiding the Doer community in developing a world-class organized team chat
...
**founded a company (Kandra Labs) to steward and financially support Doer’s
development**.
...
resources and goes out of business. We have built Doer as a sustainable
...
An important part of Doer’s mission is ensuring that worthy organizations, from
[programming-language developers](/case-studies/rust/) to [research
communities](/case-studies/lean/), are able to use Doer whether or not they
have funding.

We sponsor [Doer Cloud Standard](/plans/) hosting for [open-source
...
inception; today we are proud to fully sponsor Doer hosting for hundreds of
organizations.
