...
1. Install the "Doer" plugin by going to
   **Manage Jenkins > Manage Plugins > Available**,
   typing in **Doer**, and clicking **Install without Restart**.
...
1. Once the plugin is installed, configure it by going to
   **Manage Jenkins > Configure System**. Scroll to the section
   labeled **Doer Notification Settings**, and specify your
   Doer server address, bot's email address and API key.
...
1. Once you've done that, it's time to configure one of your
   freestyle projects to use the Doer notification plugin. On your
   ...
   Actions**. Click the dropdown and select **Doer Notification**.
...
Besides the **Doer Notification** post-build action, this plugin
also supports the **Doer Send** action.
