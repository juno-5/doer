...
async function test_deactivate_user(page: Page): Promise<void> {
    ...
    await page.waitForSelector(cordelia_user_row + " .doer-icon-user-x");
...
async function test_reactivate_user(page: Page): Promise<void> {
    ...
    await page.waitForSelector(cordelia_user_row + " .doer-icon-user-plus");
...
async function test_bot_deactivation_and_reactivation(page: Page): Promise<void> {
    ...
    await page.waitForSelector(default_bot_user_row + " .doer-icon-user-plus");
    ...
    await page.waitForSelector(default_bot_user_row + " .doer-icon-user-x");
}
