...
https://github.com/doer/doer/commit/fc0b7c00f16316a554349f0ad58c6517ebdd7ac4
...
/*
    ...
    out of Doer to ensure the annotations are included in what is
...
export function copy_handler(ev: ClipboardEvent): boolean {
    ...
    // `Ctrl+C` in Doer (note that this is totally independent of the
...
export function analyze_selection(selection: Selection): {
    ...
    for (i = 0; i < selection.rangeCount; i += 1) {
        ...
        // start_id is the Doer message ID of the first message
