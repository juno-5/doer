Get Doer notifications for your Buildbot builds!
...
1. Edit the Buildbot configuration file to add a new Doer reporter
 ([or follow the steps listed here][1]):
    ...
    is the API key of your Doer bot, and `stream` is set to the channel name
