...
class RhodecodeHookTests(WebhookTestCase):
    def test_push_event_message(self) -> None:
        expected_topic_name = "u/yuroitaki/doer-testing / master"
        expected_message = "yuroitaki pushed 1 commit to branch master. Commits by Yuro Itaki <yuroitaki@email.com> (1).\n\n* Modify README ([2b8c0ebf507](https://code.rhodecode.com/u/yuroitaki/doer-testing/changeset/2b8c0ebf50710bc2e1cdb6a33071dd2435ad667c))"
    ...
    def test_push_local_branch_without_commits(self) -> None:
        expected_topic_name = "u/yuroitaki/doer-testing / dev"
    ...
    def test_push_multiple_committers(self) -> None:
        expected_topic_name = "u/yuroitaki/doer-testing / master"
        expected_message = "yuroitaki pushed 2 commits to branch master. Commits by Itachi Sensei <itachisensei@email.com> (1) and Yuro Itaki <yuroitaki@email.com> (1).\n\n* Add test.py ([b0d892e1cdd](https://code.rhodecode.com/u/yuroitaki/doer-testing/changeset/b0d892e1cdd4236b1f74debca1772ea330ff5acd))\n* Modify test.py ([6dbae5f842f](https://code.rhodecode.com/u/yuroitaki/doer-testing/changeset/6dbae5f842f80ccb05508a1de7aace9d0f327473))"
    ...
    def test_push_multiple_committers_with_others(self) -> None:
        expected_topic_name = "u/yuroitaki/doer-testing / master"
        commits_info = "* Modify test.py ([6dbae5f842f](https://code.rhodecode.com/u/yuroitaki/doer-testing/changeset/6dbae5f842f80ccb05508a1de7aace9d0f327473))\n"
        expected_message = f"yuroitaki pushed 6 commits to branch master. Commits by Itachi Sensei <itachisensei@email.com> (2), Yuro Itaki <yuroitaki@email.com> (2), Jonas Nielsen <jonasnielsen@email.com> (1) and others (1).\n\n* Add test.py ([b0d892e1cdd](https://code.rhodecode.com/u/yuroitaki/doer-testing/changeset/b0d892e1cdd4236b1f74debca1772ea330ff5acd))\n{commits_info * 4}* Add test.py ([b0d892e1cdd](https://code.rhodecode.com/u/yuroitaki/doer-testing/changeset/b0d892e1cdd4236b1f74debca1772ea330ff5acd))"
        self.check_webhook(
    ...
    def test_push_commits_more_than_limit(self) -> None:
        expected_topic_name = "u/yuroitaki/doer-testing / master"
        commits_info = "* Modify README ([2b8c0ebf507](https://code.rhodecode.com/u/yuroitaki/doer-testing/changeset/2b8c0ebf50710bc2e1cdb6a33071dd2435ad667c))\n"
    ...
    def test_push_remove_branch(self) -> None:
        expected_topic_name = "u/yuroitaki/doer-testing / dev"
        expected_message = "yuroitaki pushed 1 commit to branch dev. Commits by Yuro Itaki <yuroitaki@email.com> (1).\n\n* Deleted branch dev ([delete_bran](https://code.rhodecode.com/u/yuroitaki/doer-testing/changeset/delete_branch=%3Edev))"
